...
servidor(a) seja professor(a) terá uma linha de crédito especial com uma taxa de
...
let fullName = "André Leal";
let server = true;
let teacher = false;

if(server === true && teacher === true){
    console.log("Parabéns " + fullName + "! Você tem acesso a nossa linha de crédito especial!")
}else if(server === true && teacher === false){
    console.log("Parabéns " + fullName + "! Você tem acesso a nossa linha de crédito para servidores!")
}else{
