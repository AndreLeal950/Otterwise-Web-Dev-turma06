/* 11 - O dono de uma livraria resolveu que precisava de novas funcionalidades no
...
let autorMaisVendido = arrayBiblioteca[2];
let livroMenorValor = arrayBiblioteca[3];
let livroMaiorValor = arrayBiblioteca[3];
let nomeLivro = arrayBiblioteca[1];
let autorLivro = arrayBiblioteca[2];
let codigoLivro = arrayBiblioteca[0];
let listaEstoque = arrayBiblioteca[4];
let livrosMaisVendidos = arrayBiblioteca[4]; //(será um valor inserido como entrada);
let aumentaValor = arrayBiblioteca[3];  //(será um valor inserido como entrada);

const maisVendidoAutor = () =>{
for(let i=0; i < arrayBiblioteca.length; i++){
    autorMaisVendido = arrayBiblioteca[i].autor
    livrosMaisVendidos = arrayBiblioteca[i].quantidadeVendido
    if(livrosMaisVendidos){
    console.log(`O autor mais vendido foi: ${autorMaisVendido} com ${livrosMaisVendidos} livros`);
        }
    }   
}
maisVendidoAutor();